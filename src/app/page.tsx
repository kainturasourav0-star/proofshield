...
export default function LandingPage() {
  ...
  const pageBar = useSpring(pageProgress, { stiffness: 180, damping: 28, mass: 0.35 })
  ...
  return (
    <div className="site-shell min-h-screen overflow-hidden bg-[#0b0d0c] text-[#f4f1e9]">
      {!reducedMotion && <motion.div style={{ scaleX: pageBar }} className="pointer-events-none fixed inset-x-0 top-0 z-[100] h-[2px] origin-left bg-lime-300" aria-hidden="true" />}
